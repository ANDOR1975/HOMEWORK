...
//}
//
///*написать перегрузку функции, которая будет умножать два
//или три числа разных типов int или double, всего будет 4 перегрузки */
//
...
//}
//
//int multiplay(double r, int c,int a)
//{
//	return (r* c* a);
//}
//
...
//	cout << " int*double=int " << multiplay(b, r) << '\n';
//	cout << " double*int*int=int " << multiplay(r, a, b ) << '\n';
//}
//
//
